...
class TestParserVideoPages(unittest.TestCase):
  ...
  @patch('franck.parser._get_soup', side_effect=get_soup_homepage)
  ...
  @patch('franck.parser._get_soup', side_effect=get_soup_video_section)
  ...
  @patch('franck.parser._get_soup', side_effect=get_soup_video_list)
...
class TestParserVideoConfigUrl(unittest.TestCase):
  ...
  @patch('franck.parser._get_soup', side_effect=get_soup_video_page)
